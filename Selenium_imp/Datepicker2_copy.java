...
public static WebDriver driver;
	...
	public static void SelectDate(String checkinday, String checkinMonth)throws InterruptedException {
	...
	//	   driver.findElement(By.xpath("//*[@title='Next']")).click();
		   ...
		   if(checkinMonth.equalsIgnoreCase(currmonth)) {
			   ...
			   for(int i=1;i<12;i++) {
				   ...
				   if(checkinday.equalsIgnoreCase(currmonth)) {
					   System.out.println("month selected");
					   break;
				   }
